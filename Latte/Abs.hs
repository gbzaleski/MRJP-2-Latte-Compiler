...
data TopDef' a
    ...
    | CDef a Ident (CBlock' a)
    | CExtDef a Ident Ident (CBlock' a)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
...
data CBlock' a = CBlock a [CStmt' a]
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
...
data Stmt' a
    ...
    | Ass a Ident (Expr' a)
    | CAss a (Expr' a) Ident (Expr' a)
    | Incr a Ident
    | CIncr a (Expr' a) Ident
    | Decr a Ident
    | CDecr a (Expr' a) Ident
    | Ret a (Expr' a)
    | VRet a
