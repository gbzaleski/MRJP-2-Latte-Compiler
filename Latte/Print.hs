...
instance Print (Latte.Abs.TopDef' a) where
  prt i = \case
    ...
    Latte.Abs.CDef _ id_ cblock -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id_, prt 0 cblock])
    Latte.Abs.CExtDef _ id_1 id_2 cblock -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id_1, doc (showString "extends"), prt 0 id_2, prt 0 cblock])
...
instance Print (Latte.Abs.CBlock' a) where
  prt i = \case
...
instance Print (Latte.Abs.CItem' a) where
  prt i = \case
    Latte.Abs.CItem _ id_ -> prPrec i 0 (concatD [prt 0 id_])
...
instance Print (Latte.Abs.Stmt' a) where
  prt i = \case
    ...
    Latte.Abs.CAss _ expr1 id_ expr2 -> prPrec i 0 (concatD [prt 6 expr1, doc (showString "."), prt 0 id_, doc (showString "="), prt 0 expr2, doc (showString ";")])
    Latte.Abs.Incr _ id_ -> prPrec i 0 (concatD [prt 0 id_, doc (showString "++"), doc (showString ";")])
    Latte.Abs.CIncr _ expr id_ -> prPrec i 0 (concatD [prt 6 expr, doc (showString "."), prt 0 id_, doc (showString "++"), doc (showString ";")])
    Latte.Abs.Decr _ id_ -> prPrec i 0 (concatD [prt 0 id_, doc (showString "--"), doc (showString ";")])
    Latte.Abs.CDecr _ expr id_ -> prPrec i 0 (concatD [prt 6 expr, doc (showString "."), prt 0 id_, doc (showString "--"), doc (showString ";")])
...
instance Print (Latte.Abs.Type' a) where
  prt i = \case
    ...
    Latte.Abs.Class _ id_ -> prPrec i 0 (concatD [prt 0 id_])
...
instance Print (Latte.Abs.Expr' a) where
  prt i = \case
    ...
    Latte.Abs.ECMeth _ expr id_ exprs -> prPrec i 6 (concatD [prt 6 expr, doc (showString "."), prt 0 id_, doc (showString "("), prt 0 exprs, doc (showString ")")])
    Latte.Abs.EAttr _ expr id_ -> prPrec i 6 (concatD [prt 6 expr, doc (showString "."), prt 0 id_])
    Latte.Abs.ECNew _ id_ -> prPrec i 6 (concatD [doc (showString "new"), prt 0 id_])
    Latte.Abs.ECNull _ id_ -> prPrec i 5 (concatD [doc (showString "("), prt 0 id_, doc (showString ")null")])
    Latte.Abs.EString _ str -> prPrec i 5 (concatD [printString str])
    Latte.Abs.Neg _ expr -> prPrec i 5 (concatD [doc (showString "-"), prt 5 expr])
    Latte.Abs.Not _ expr -> prPrec i 5 (concatD [doc (showString "!"), prt 5 expr])
