...
transTopDef x = case x of
  ...
  Latte.Abs.CDef _ ident cblock -> failure x
  Latte.Abs.CExtDef _ ident1 ident2 cblock -> failure x

transArg :: Show a => Latte.Abs.Arg' a -> Result
transArg x = case x of
  Latte.Abs.Arg _ type_ ident -> failure x

transCBlock :: Show a => Latte.Abs.CBlock' a -> Result
transCBlock x = case x of
...
transStmt x = case x of
  ...
  Latte.Abs.CAss _ expr1 ident expr2 -> failure x
  Latte.Abs.Incr _ ident -> failure x
  Latte.Abs.CIncr _ expr ident -> failure x
  Latte.Abs.Decr _ ident -> failure x
  Latte.Abs.CDecr _ expr ident -> failure x
...
transExpr x = case x of
  ...
  Latte.Abs.ECMeth _ expr ident exprs -> failure x
  Latte.Abs.EAttr _ expr ident -> failure x
  Latte.Abs.ECNew _ ident -> failure x
  Latte.Abs.ECNull _ ident -> failure x
